...
e3.. -(59405.9405940594 + 2121.64073550212*x4)*x7/(x3*x4*(0.0833333333333333*
     sqr(x4) + sqr(0.5*i1 + 0.5*x3))) + x6 =E= 0;
...
e8.. 0.0204744897959184*sqrt(1e15*POWER(i2,3)*i1*i1*POWER(i2,3))*(1 - 
     0.0282346219657891*i1) =G= 6000;

e9.. -0.21952/(POWER(i1,3)*i2) =G= -0.25;
